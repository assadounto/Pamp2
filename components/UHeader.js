  ...
  return (
    <View
      style={{
        ...
        marginTop: Platform.OS==='ios'?verticalScale(45):10,
      }}
    >
      <View
        style={{
      ...
      >
        <TouchableOpacity onPress={() => { dispatch(setNextNav('main')); !user?.id?navigation.navigate('login') : navigation.navigate('Profile')}}>
          <FastImage
            source={
              user?.id && user?.image
